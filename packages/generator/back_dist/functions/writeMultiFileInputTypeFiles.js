...
const writeTrFieldSchema_1 = require("./contentWriters/writeTrFieldSchema");
const writeInputTypeFiles = ({ path, dmmf }) => {
    ...
    if (folderPath) {
        ...
        if (dmmf.schema.hasJsonTypes) {
            new classes_1.FileWriter().createFile(`${folderPath}/TrFieldSchema.ts`, (fileWriter) => (0, writeTrFieldSchema_1.writeTrFieldSchema)({ fileWriter, dmmf }));
